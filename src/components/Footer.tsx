      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <a href="#pillars" className="text-gray-400 hover:text-amber-400 transition-colors">
                  Our Programs
                </a>
              </li>
              <li>
                <a href="#impact" className="text-gray-400 hover:text-amber-400 transition-colors">
                  Impact Stories
                </a>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li className="flex items-center gap-2 text-gray-400">
                ...
                <span> +254722458294</span>
                <span>+254717539262</span>
              </li>
              <li className="flex items-center gap-2 text-gray-400">
                <svg className="w-5 h-5 text-amber-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                </svg>
                <span>bethelchildrenshome8@gmail.Com</span>
              </li>
            </ul>
          </div>
            ...
            <div className="flex gap-4">
              ...
              >
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.437H7.078v-3.47h3.047V8.413c0-3.008 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.437C19.612 23.027 24 18.062 24 12.073z" />
                </svg>
              </a>
              <a
                href="#"
        ...
        <div className="border-t border-gray-800 mt-12 pt-8 text-center">
          <p className="text-gray-500">
            © {currentYear} Bethel Home. All rights reserved. | Building Brighter Futures, One Child at a Time.
          </p>
        </div>
      </div>
    </footer>
